...
class TestSuccessfullLogin:
    def test_login_from_main_page(self,driver):
        ...
        WebDriverWait(driver, 10).until(expected_conditions.url_to_be(Links.base_url))
        ...
        WebDriverWait(driver, 10).until(expected_conditions.url_to_be(Links.base_url))
        assert driver.current_url == Links.base_url
    ...
    def test_login_from_registration_page(self, driver):
        ...
        WebDriverWait(driver, 10).until(
            expected_conditions.url_to_be(Links.link_registration_page)
        )
        ...
        driver.find_element(By.XPATH, Locators.login_button_login_page).click()
        WebDriverWait(driver, 10).until(
            expected_conditions.url_to_be(Links.base_url)
        )
        assert driver.current_url == Links.base_url
    ...
    def test_login_from_forgot_password_page(self,driver):
        driver.get(Links.link_forgot_password_page)
        WebDriverWait(driver, 10).until(expected_conditions.url_to_be(Links.link_forgot_password_page))
